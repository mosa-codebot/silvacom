...
export class AppComponent implements OnInit {
    ...
    openWeatherApiKey = "7e1ede4276f9c1ac7d8134c59abf9036";
    title = 'Trip Planner';
    city= 'Edmonton';
    currentWeather = '';
    currentTemperature = '';
    ...
    private updateInfo(city){
        ...
        this.http.get('http://api.openweathermap.org/data/2.5/weather?q=' + city + this.openWeatherApiKey)
            .subscribe((data:any) => {
            this.currentWeather =  data.weather[0].description;
            this.cityName =  data.name;
            this.currentTemperature = Math.round(data.main.temp - 273.15) + 'ºC';//convert Kelvin result to celsius
        });
